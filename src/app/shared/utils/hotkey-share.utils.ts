import { IHotkeyProfile, IShareProfileItem, IHotkeyProfileCreate, isShareProfileItem } from '../models/hotkeys.models';

/** Transform profile to share format (remove id for portability) */
export function transformProfileToShare(profile: IHotkeyProfile): IShareProfileItem {
...
export function transformShareToProfile(shareItem: IShareProfileItem): IHotkeyProfileCreate {
    return {
