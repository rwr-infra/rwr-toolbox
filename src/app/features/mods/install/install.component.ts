...
export class InstallComponent implements OnInit {
  ...
  onInstall(): void {
    ...
    this.modService.installMod(this.selectedFilePath, targetPath, this.installOptions).subscribe({
      next: () => {
  ...
  onBackup(): void {
    ...
    this.modService.makeBackup(this.selectedFilePath, this.modInfo.file_path_list, targetPath).subscribe({
      next: (backupPath) => {
  ...
  onRecover(): void {
    ...
    if (!confirm('This will replace current files with backup. Continue?')) {
      return;
    }
