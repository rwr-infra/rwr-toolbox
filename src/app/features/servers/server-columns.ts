import { ServerColumn, ServerColumnVisibility } from '../../shared/models/server.models';
...
export const SERVER_COLUMNS: ServerColumn[] = [
    ...
    { key: 'address', label: 'IP Address', i18nKey: 'servers.column.address', alignment: 'left' },
    { key: 'port', label: 'Port', i18nKey: 'servers.column.port', alignment: 'center' },
    ...
    { key: 'dedicated', label: 'Dedicated', i18nKey: 'servers.column.dedicated', alignment: 'center' },
